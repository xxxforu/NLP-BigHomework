...
# Create a callback to save weights
checkpoint_path = "encoder_decoder_weights.weights.h5"  # 修改文件名以符合要求
...
def translate(text, max_encoder_seq_length, max_decoder_seq_length):
    ...
    while not stop_condition:
        ...
        if sampled_token == '<end>' or len(decoded_text) > max_decoder_seq_length:
            stop_condition = True
