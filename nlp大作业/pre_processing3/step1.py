...
# 加载数据文件并进行预处理
file_path = 'clean3.txt'  # 请确保数据文件位于该路径下
...
df['English'].to_csv('english_sentences.txt', index=False, header=False)
df['Chinese'].to_csv('chinese_sentences.txt', index=False, header=False)
